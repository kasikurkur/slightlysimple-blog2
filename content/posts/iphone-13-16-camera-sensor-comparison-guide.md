...
| **iPhone 13 Pro** | 1/1.66" | 1.9μm | 12MP | f/1.5 | センサーシフト式 | 史上最大のピクセルサイズを実現 |
| **iPhone 13 Pro Max** | 1/1.66" | 1.9μm | 12MP | f/1.5 | センサーシフト式 | 低照度性能2.2倍向上 |
...
| **iPhone 16** | 1/1.28"（推定） | 1.22μm（48MP時）<br>2.44μm（12MP時） | 48MP | f/1.6 | 第2世代センサーシフト式 | 従来センサー継続使用の可能性 |
| **iPhone 16 Plus** | 1/1.28"（推定） | 1.22μm（48MP時）<br>2.44μm（12MP時） | 48MP | f/1.6 | 第2世代センサーシフト式 | 従来センサー継続使用の可能性 |
| **iPhone 16 Pro** | 1/1.28"（未確認） | 1.22μm（推定） | 48MP | f/1.79 | 第2世代センサーシフト式 | センサー仕様について専門家間で論争中 |
| **iPhone 16 Pro Max** | 1/1.28"（未確認） | 1.22μm（推定） | 48MP | f/1.79 | 第2世代センサーシフト式 | センサー仕様について専門家間で論争中 |
