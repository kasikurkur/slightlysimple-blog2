...
4. サイトURL: https://kasikurkur.github.io/slightlysimple-blog2/
5. 「Enforce HTTPS」をチェック

### 4. 独自ドメイン設定（オプション）
1. ドメインレジストラの管理画面でCNAME設定
   - www.yourdomain.com → kasikurkur.github.io
2. GitHub Pages設定でカスタムドメイン入力
3. `config.yaml` の `baseURL` を独自ドメインに更新
